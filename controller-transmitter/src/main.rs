...
use crate::wifi::{
    ieee80211_frame::{FrameControl, MacAddr, NoDsWifiPacketFrame, SequenceControl},
    radiotap::{
...
fn main() {
    ...
    let wifi_frame = NoDsWifiPacketFrame {
        frame_control: FrameControl::get_data_no_ds_frame_control(),
        duration: 0x0000,
        address_1: MacAddr {
    ...
    let wifi_frame_data = unsafe {
        core::slice::from_raw_parts_mut(frame_pointer, mem::size_of::<NoDsWifiPacketFrame<6>>())
    };
